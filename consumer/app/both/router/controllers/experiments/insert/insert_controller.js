...
this.ExperimentsInsertController = RouteController.extend({
	template: "ExperimentsInsert",
	...
	isReady: function() {
		...
		var subs = [
			...
			Meteor.subscribe("experiments_empty")
		];
		var ready = true;
	...
	data: function() {
		...
		return {
			...
			experiments_empty: Experiments.findOne({_id:null}, {})
		};
		/*DATA_FUNCTION*/
	},
